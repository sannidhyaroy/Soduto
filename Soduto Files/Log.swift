...
/// ```swift
/// // Instead of:
/// Logger.filesystem.debug("File \(filename, privacy: .public) size \(size, privacy: .public)")
///
/// // Write:
/// Logger.filesystem.debug("File \(pub: filename) size \(pub: size)")
/// ```
///
/// ## When to use `pub:` vs default (redacted)
/// - **Use `pub:`**: File names, paths, sizes, operation types
/// - **Keep redacted**: Credentials, personal data
